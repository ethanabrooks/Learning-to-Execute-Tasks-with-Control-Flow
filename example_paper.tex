...
\end{tikzpicture}
\caption{Diagram of architecture that maps the
...
\begin{figure*}[]
  ...
  \begin{subfigure}{.33\textwidth}
    \centering
    \centerline{\includegraphics[trim=20 0 39 28, clip, width=\columnwidth]{figures/eval40}}
...
\begin{figure}[t]
\vskip 0.2in
\centerline{\includegraphics[width=\columnwidth]{gru_rewards}}
