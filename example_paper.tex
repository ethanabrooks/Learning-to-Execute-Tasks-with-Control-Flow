...
thin, draw,
  ...
  (-30,67) -- (-30,77) node[midway,left,inner sep=.1ex,text
    width=14mm,font=\tiny]{\tiny $\ell$ distributions};
  \draw [decorate,decoration={brace}]
  ...
  \fill[black!40] (12,69) rectangle (16,71);
  \fill[black!30] (16,69) rectangle (20,71);
  \fill[black!20] (20,69) rectangle (24,71);
  ...
  \fill[black!40] (12,71) rectangle (16,73);
  \fill[black!30] (16,71) rectangle (20,73);
  ...
  \fill[black!60] (-16,75) rectangle (-12,77);
...
baseline architectures on the complex $6\times6$ environment.
...
\begin{figure*}[th]
  ...
  \end{subfigure}%
  \caption{These graphs depict performance on the complex $6\times6$ environment. Details are provided in
section \ref{results}.}
  \label{complex}
\end{figure*}
...
%\begin{subfigure}
  %\centering
%\centerline{\includegraphics[width=\columnwidth]{complex-eval}}
%\caption{This graph compares the performance of our architecture with the
%baseline architectures on the complex environment with tasks twice as long as those trained (20 lines).
%Details are provided in section \ref{results}.}
%\label{complex}
%\end{subfigure}
%%\begin{subfigure}
  %%\centering
%%\centerline{\includegraphics[width=\columnwidth]{complex-train}}
%%\caption{This graph compares the performance of our architecture with the
%%baseline architectures on the complex environment with tasks twice as long as those trained (20 lines).
%%Details are provided in section \ref{results}.}
%%\label{complex}
