...
control flow in tasks comprised of multiple subtasks. Whereas existing work
...
control-flow statements, e.g. \texttt{if} and \texttt{while}, determine the subtask
...
At the beginning of an episode our agent observes an numerical representation of
...
\subsection{Tasks}
Figure \ref{grammer} delineates the grammar for tasks used in our domain.
